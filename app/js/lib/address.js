...
function JusoSearch (selector, objCalled) {
    ...
    var searchResultWindow = wrapper.querySelector(".result-list");
    ...
    var jusoSearchInput = searchForm.querySelector("input");
    ...
    function returnSelectedJuso (event) {
        ...
        callApi("GET", "/api/coordinate/", coordinateParam, 
            function(resData) {
                ...
                selectedJuso = jusoContainer[jusoIdx];
                console.log("+++++++++++++++++++++++++++++++selectedJuso+++++++++++++++++++++", selectedJuso);
    ...
    function initEvent () {
        ...
        removeAllEvent(); // 일단 기존 이벤트 모두 제거하고 다시 세팅

        console.log("++++++++++++++++++++++++++++++주소 모듈 이벤트 바인딩++++++++++++++++++++++++++");
    ...
    function removeAllEvent() {
        console.log("이벤트 제거합니다. ~~~~~~~~~~~~~~~~~~~~~~~~~`");
        searchResultWindow.removeEventListener("scroll", scrollEvent);
        searchForm.removeEventListener("submit", submit );
        $(searchResultWindow).off("click", returnSelectedJuso);
    }
