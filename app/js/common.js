...
if (typeof window.CustomEvent !== "function") {
	function CustomEvent(event, params) {
		...
		var param = params || {bubbles: false, cancelable: false, detail: undefined};
...
var CODE_CONTAINER = (function() {
	return {
		...
		getHospitalTypeCode: function() {
			return [{value: "HIRA_41", text: "치과의원"}, {value: "HIRA_51", text: "치과병원"}, {value: "DP_10", text: "치과기공소"}, {value: "HIRA_11", text: "종합병원"}, {value: "DP_45", text: "네트워크치과"}, {value: "DP_00", text: "개원예정"}, {value: "0", text: "기타(직접 입력)"}];
		},
			...
			return [
				{
					...
					element: [
						...
						{value: "EMP.1", group: "EMP", text: "정규직"}, {value: "EMP.2", group: "EMP", text: "계약직"}, {value: "EMP.3", group: "EMP", text: "아르바이트"}
					]
				}, {
					group: "AREA",
					text: "채용부문",
					element: [
						...
						{value: "AREA.1", group: "AREA", text: "치위생사"}, {value: "AREA.2", group: "AREA", text: "간호조무사"}, {value: "AREA.3", group: "AREA", text: "치기공사"}, {value: "AREA.4", group: "AREA", text: "보험청구사"}, {value: "AREA.5", group: "AREA", text: "코디네이터"}, {value: "AREA.6", group: "AREA", text: "의사"}, {value: "AREA.7", group: "AREA", text: "기타"}
					]
				}, {
					group: "TASK",
					text: "담당업무",
					element: [
						...
						{value: "TASK.1", group: "TASK", text: "진료실"}, {value: "TASK.2", group: "TASK", text: "데스크"}, {value: "TASK.3", group: "TASK", text: "상담"}, {value: "TASK.4", group: "TASK", text: "보험청구"}, {value: "TASK.5", group: "TASK", text: "치과내 기공실"}, {value: "TASK.6", group: "TASK", text: "치과기공소"}, {value: "TASK.7", group: "TASK", text: "관리및경영"}, {value: "TASK.8", group: "TASK", text: "의사"}, {value: "TASK.9", group: "TASK", text: "기타"}
					]
				}
			];
		},
